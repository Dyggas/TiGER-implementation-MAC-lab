...
\noindent Можна бачити що: TiGER128 та TiGER256 мають конкурентні розміри порівняно з Kyber та Saber. TiGER192 має помітно більші розміри 
(+24\% порівняно з Kyber768), що є компромісом за вищу надійність дешифрування (визначається по показнику DFP/R);

\subsection*{Узагальнююче порівняння характеристик}

У цю таблицю ми включимо усі параметри і особливості, які розглядали до цього, щоб зробити комплесний порівняльний аналіз 
на першому рівні NIST:
