...
всіх постквантових алгоритмів, side-channel атаки становлять серйозну практичну загрозу.
...
\begin{itemize}
    ...
    \item VPN та IPsec: Інтеграція TiGER в IKEv2/IPsec протоколи забезпечуватиме квантово-стійке шифрування 
        для VPN-з'єднань.
\end{itemize}
